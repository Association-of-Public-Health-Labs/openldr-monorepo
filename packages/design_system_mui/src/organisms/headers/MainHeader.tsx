...
import {UserNavigation, UserNavigationProps} from "../../molecules/headers/UserNavigation";
...
export function MainHeader ({ children, user, settings, handleSetAppSettings, handleOpenSettingsModal, sx }: MainHeaderProps) {

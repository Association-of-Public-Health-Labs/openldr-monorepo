...
export type MainCardHeaderOptions = {
  label: string;
...
export function MainCardHeader({title, subtitle, options, additionalOptions, containerProps, width="100%", handleSetContextOptions}: MainCardHeaderProps) {

...
import { MainCardHeaderOptions } from "../molecules/cards/MainCardHeader";

type CardContextProps = {
  additionalOptions?: MainCardHeaderOptions[]; 
  handleSetContextOptions: (options: MainCardHeaderOptions[]) => void;
}
...
export function CardProvider({children, csvFile}: Props) {
  ...
  const [contextOptions, setContextOptions] = useState<MainCardHeaderOptions[]>([]);
  ...
  const handleSetContextOptions = (options: MainCardHeaderOptions[]) => {
    setContextOptions(options);
  }

  return (
    <CardContext.Provider value={{handleSetContextOptions: function (options: MainCardHeaderOptions[]){setContextOptions(options)}}}>

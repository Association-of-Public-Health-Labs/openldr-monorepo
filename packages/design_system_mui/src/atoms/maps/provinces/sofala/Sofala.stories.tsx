...
import { Sofala, SofalaProps } from "./Sofala";
import { Box, Typography } from "@mui/material";

const meta: Meta<typeof Sofala> = {
  title: "DesignSystem/Atoms/Maps/Provinces/Sofala",
  component: Sofala,
  tags: ["autodocs"],
  parameters: {
    docs: {
...
const Template: StoryFn<SofalaProps> = (args) => <Sofala {...args} />;

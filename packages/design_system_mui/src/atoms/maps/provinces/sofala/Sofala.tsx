...
export function Sofala({ 
  ...
  const addPathEventListeners = useCallback((path: HTMLElement, districtClass: string, districtName: string, ratio: number) => {
    ...
    path.addEventListener('click', () => {
      if (districtClass.includes('MZ0700')) {
  ...
  return (
    ...
    >
      <ReactSVG
        src="https://res.cloudinary.com/dduwau07t/image/upload/v1754605761/samples/sf_yi94ge.svg"
        onError={(error) => {

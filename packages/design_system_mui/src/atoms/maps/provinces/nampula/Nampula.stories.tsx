...
import { Nampula, NampulaProps } from "./Nampula";
import { Box, Typography } from "@mui/material";

const meta: Meta<typeof Nampula> = {
  title: "DesignSystem/Atoms/Maps/Provinces/Nampula",
  component: Nampula,
  tags: ["autodocs"],
  parameters: {
    docs: {
...
const Template: StoryFn<NampulaProps> = (args) => <Nampula {...args} />;

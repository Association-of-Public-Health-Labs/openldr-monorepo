...
const DISTRICT_MAP: Record<string, string> = {
  "MZ0300K1":	"Cidade de Nampula",
  "MZ0300K2":	"Angoche",
  "MZ0300K3":	"Namapa-Erati",
  "MZ0300K4":	"Ilha de Mocambique",
  "MZ0300K5":	"Lalaua",
  "MZ0300K6":	"Malema",
  "MZ0300K7":	"Meconta",
  "MZ0300K8":	"Mecuburi",
  ...
  "MZ0300L6":	"Muecate",
  "MZ0300L7":	"Murrupula",
  "MZ0300L8":	"Nacala Porto",
  "MZ0300L9":	"Nacala Velha",
  "MZ0300M1":	"Nacaroa",
  "MZ0300M3":	"Ribaue",
  "MZ0300M4":	"Larde",
  "MZ0300M5":	"Liupo",
...
export function Nampula({ 
  ...
  const addPathEventListeners = useCallback((path: HTMLElement, districtClass: string, districtName: string, ratio: number) => {
    ...
    path.addEventListener('click', () => {
      if (districtClass.includes('MZ0300')) {
  ...
  return (
    ...
    >
      <ReactSVG
        src="https://res.cloudinary.com/dduwau07t/image/upload/v1754604399/samples/np_pgdttg.svg"
        onError={(error) => {

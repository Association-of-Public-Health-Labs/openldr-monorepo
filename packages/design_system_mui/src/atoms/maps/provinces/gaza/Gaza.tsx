...
const DISTRICT_MAP: Record<string, string> = {
  "MZ0900C1":	"Xai-Xai",
  "MZ0900C2":	"Bilene Macia",
  "MZ0900C3":	"Chibuto",
  "MZ0900C4":	"Chicualacuala",
  "MZ0900C5":	"Chigubo",
  "MZ0900C6":	"Chokwe",
  "MZ0900C7":	"Guija",
  "MZ0900C8":	"Mabalane",
...
export function Gaza({ 
  ...
  const addPathEventListeners = useCallback((path: HTMLElement, districtClass: string, districtName: string, ratio: number) => {
    ...
    path.addEventListener('click', () => {
      if (districtClass.includes('MZ0900')) {
  ...
  return (
    ...
    >
      <ReactSVG
        src="https://res.cloudinary.com/dduwau07t/image/upload/v1754606398/samples/gz_ndiab1.svg"
        onError={(error) => {

...
export function Zambezia({ 
  ...
  const addPathEventListeners = useCallback((path: HTMLElement, districtClass: string, districtName: string, ratio: number) => {
    ...
    path.addEventListener('click', () => {
      if (districtClass.includes('MZ0400')) {
  ...
  return (
    ...
    >
      <ReactSVG
        src="https://res.cloudinary.com/dduwau07t/image/upload/v1754604737/samples/zb_mqgmfg.svg"
        onError={(error) => {

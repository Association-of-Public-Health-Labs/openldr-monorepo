...
export function Inhambane({ 
  ...
  const addPathEventListeners = useCallback((path: HTMLElement, districtClass: string, districtName: string, ratio: number) => {
    ...
    path.addEventListener('click', () => {
      if (districtClass.includes('MZ0800')) {
  ...
  return (
    ...
    >
      <ReactSVG
        src="https://res.cloudinary.com/dduwau07t/image/upload/v1754606110/samples/ib_gsay4x.svg"
        onError={(error) => {

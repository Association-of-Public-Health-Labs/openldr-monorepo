...
import { Manica, ManicaProps } from "./Manica";
import { Box, Typography } from "@mui/material";

const meta: Meta<typeof Manica> = {
  title: "DesignSystem/Atoms/Maps/Provinces/Manica",
  component: Manica,
  tags: ["autodocs"],
  parameters: {
    docs: {
...
const Template: StoryFn<ManicaProps> = (args) => <Manica {...args} />;

...
import { MaputoProvincia, MaputoProvinciaProps } from "./MaputoProvincia";
import { Box, Typography } from "@mui/material";

const meta: Meta<typeof MaputoProvincia> = {
  title: "DesignSystem/Atoms/Maps/Provinces/MaputoProvincia",
  component: MaputoProvincia,
  tags: ["autodocs"],
  parameters: {
    docs: {
      description: {
...
const Template: StoryFn<MaputoProvinciaProps> = (args) => <MaputoProvincia {...args} />;

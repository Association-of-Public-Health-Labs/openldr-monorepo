...
import { InteractiveSvgMap, InteractiveSvgMapProps } from "./InteractiveSvgMap";

const meta: Meta<typeof InteractiveSvgMap> = {
  title: "DesignSystem/Atoms/Maps/InteractiveSvgMap",
...
const Template: StoryFn<InteractiveSvgMapProps> = (args) => <InteractiveSvgMap {...args} />;
...
Default.args = {
  ...
  showPopover: true,
  getPopoverContent: (provinceName, ratio, color) => {
    return (
      <Box>
        <Box sx={{

...
export type ShowIndicatorsProps = {
  0: boolean,
  1: boolean,
}
...
export interface InteractiveSvgMapProps {
  ...
  showIndicators?: ShowIndicatorsProps;
  onClick?: (value) => void;
  highlightedColor?: string;
  hideNames?: boolean;
...
export const InteractiveSvgMap = ({
  ...
  const addPopoverEvents = useCallback((svgElement: SVGElement) => {
    ...
    paths.forEach(path => {
      ...
      const provinceData = provinces?.[provinceId as keyof ProvincesProps]
        ...
        >
          <g id="admin1">
            <path
              ...
              strokeWidth="0.4"
              id="np"
              style={{opacity: provinces?.np?.ratio, fill: pathDefaultBackgroundColor}}
            ...
            <path
              ...
              id="ib"
              style={{opacity: provinces?.ib?.ratio, fill: pathDefaultBackgroundColor}}
            ...
            <path
              ...
              strokeWidth="0.4"
              id="mc"
              style={{opacity: provinces?.mc?.ratio, fill: pathDefaultBackgroundColor}}
            ...
            <path
              ...
              strokeWidth="0.4"
              id="zb"
              style={{opacity: provinces?.zb?.ratio, fill: pathDefaultBackgroundColor}}
            ...
            <path
              ...
              strokeWidth="0.4"
              id="mp"
              style={{opacity: provinces?.mp?.ratio, fill: pathDefaultBackgroundColor}}
            ...
            <path
              ...
              strokeWidth="0.4"
              id="tt"
              style={{opacity: provinces?.tt?.ratio, fill: pathDefaultBackgroundColor}}
            ...
            <path
              ...
              strokeWidth="0.4"
              id="mn"
              style={{opacity: provinces?.mn?.ratio, fill: pathDefaultBackgroundColor}}
            ...
            <path
              ...
              strokeWidth="0.4"
              id="cd"
              style={{opacity: provinces?.cd?.ratio, fill: pathDefaultBackgroundColor}}
            ...
            <path
              ...
              strokeWidth="0.4"
              id="ns"
              style={{opacity: provinces?.ns?.ratio, fill: pathDefaultBackgroundColor}}
            ...
            <path
              ...
              strokeWidth="0.4"
              id="gz"
              style={{opacity: provinces?.gz?.ratio, fill: pathDefaultBackgroundColor}}
            ...
            <path
              ...
              strokeWidth="0.4"
              id="sf"
              style={{opacity: provinces?.sf?.ratio, fill: pathDefaultBackgroundColor}}
          ...
          {getPopoverContent ? (
            ...
            <Box>
              ...
              <Typography variant="body2" color="text.secondary">
                Ratio: {(popoverContent.ratio * 100).toFixed(1)}%
              </Typography>
            </Box>
          )}
        </Box>
...
type MapIndicatorProps = {
  showIndicators: ShowIndicatorsProps | undefined;

...
export interface SelectPickerProps {
  options: SelectPickerOptionsProps[];
  placeholder: string;
  isMulti?: boolean;
  values?: SelectPickerOptionsProps[];
  isDisabled?: boolean;
  onChange: (selected: SelectPickerOptionsProps[]) => void;
      ...
      <ReactSelect
        ...
        onChange={(newValue: any) => {
          if (Array.isArray(newValue)) {
            onChange(newValue as SelectPickerOptionsProps[]);
          } else if (newValue) {
            onChange([newValue] as SelectPickerOptionsProps[]);
          } else {
            onChange([]);

...
export const IconlyLocation = ({ size = 24, color = "currentColor", style = "outline" }: IconlyIconProps) => {
...
export const IconlyOutlineLocation = ({ size = 24, color = "currentColor" }: IconlyIconProps) => {
  return (
...
export const IconlyTwoToneLocation = ({ size = 24, color = "currentColor" }: IconlyIconProps) => {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">

...
import { IconlyGrid } from "./Grid";

const meta: Meta<typeof IconlyGrid> = {
  title: "DesignSystem/Atoms/Icons/Grid",
  component: IconlyGrid,
  tags: ["autodocs"],
  argTypes: {
    size: {
      control: { type: "number" },
...
export default meta;
type Story = StoryObj<typeof IconlyGrid>;

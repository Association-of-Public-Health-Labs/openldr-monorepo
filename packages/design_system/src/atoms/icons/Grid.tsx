...
export const IconlyGrid = ({ size = 24, color = "#000000", style = "outline" }: IconlyIconProps) => {
  if(style === "two-tone") {
    return (
      <IconlyTwoToneGrid size={size} color={color}/>
    )
  }

  return (
    <IconlyOutlineGrid size={size} color={color}/>
  )
}

export const IconlyTwoToneGrid = ({ size = 24, color = "#000000" }: IconlyIconProps) => {
  return (
...
export const IconlyOutlineGrid = ({ size = 24, color = "#000000" }: IconlyIconProps) => {
  return (

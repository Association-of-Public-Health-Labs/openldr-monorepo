    ...
    >
      ...
      >
        ...
        >
          ...
          <FormControlLabel sx={{color: "text.primary"}} value="district" control={<Radio onChange={(e) => handleChangeFacility("district")} size="small" />} label={"Distrito"} />
          <FormControlLabel sx={{color: "text.primary"}}  value="clinic" control={<Radio onChange={(e) => handleChangeFacility("clinic")} size="small" />} label={"Unidade Sanitária"} />
        </RadioGroup>
      </FormControl>

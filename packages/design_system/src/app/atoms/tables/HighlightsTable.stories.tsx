...
import { HighlightsTable, type HighlightsTableProps } from "./HighlightsTable";

const meta: Meta<typeof HighlightsTable> = {
  title: "DesignSystem/Atoms/Tables/HighlightsTable",
...
const Template: StoryFn<HighlightsTableProps> = (args) => <HighlightsTable {...args} />;

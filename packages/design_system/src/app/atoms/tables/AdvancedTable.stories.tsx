...
import { AdvancedTable, type AdvancedTableProps, type AdvancedTableData, type AdvancedTableHeadCell } from "./AdvancedTable";

const columns: AdvancedTableHeadCell[] = [
...
const meta: Meta<typeof AdvancedTable> = {
  ...
  argTypes: {
    ...
    rows: {
      description: "The AdvancedTableData rows to be displayed in the table.",
      control: { type: "object" },
    },
    border: {
...
const Template: StoryFn<AdvancedTableProps> = (args) => <AdvancedTable {...args} />;

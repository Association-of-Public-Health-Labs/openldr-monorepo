...
import { ChartjsPie, type ChartjsPieProps } from "./Pie";

// Metadata for the component
const meta: Meta<typeof ChartjsPie> = {
...
const Template: StoryFn<ChartjsPieProps> = (args: ChartjsPieProps) => <ChartjsPie {...args} />;

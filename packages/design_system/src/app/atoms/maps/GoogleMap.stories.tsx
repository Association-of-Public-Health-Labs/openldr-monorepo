...
import { GoogleMapComponent, type GoogleMapProps } from "./GoogleMap";
import { Box } from "@mui/material";

const meta: Meta<typeof GoogleMapComponent> = {
...
const Template: StoryFn<GoogleMapProps> = (args: GoogleMapProps) => (
  <Box sx={{ height: "400px", width: "100%" }}>
    <GoogleMapComponent {...args} />
  </Box>
);

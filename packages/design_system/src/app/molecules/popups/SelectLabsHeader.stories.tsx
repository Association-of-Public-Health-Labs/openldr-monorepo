...
import { SelectLabsHeader, type SelectLabsHeaderProps, type LabsStateProps } from "./SelectLabsHeader";
...
// Template Function
const Template: StoryFn<SelectLabsHeaderProps> = (args: SelectLabsHeaderProps) => {

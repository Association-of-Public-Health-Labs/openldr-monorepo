...
import { DateRangeMolecule, type DateRangeMoleculeProps } from "./DateRange";

const meta: Meta<typeof DateRangeMolecule> = {
  title: "DesignSystem/Molecules/Popups/DateRange",
  component: DateRangeMolecule,
  tags: ["autodocs"],
  argTypes: {
    onChange: {
...
const Template: StoryFn<DateRangeMoleculeProps> = (args: DateRangeMoleculeProps) => <DateRangeMolecule {...args} />;

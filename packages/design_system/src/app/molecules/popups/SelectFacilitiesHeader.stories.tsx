...
import { SelectFacilitiesHeader, type SelectFacilitiesHeaderProps } from "./SelectFacilitiesHeader";
...
const Template: StoryFn<SelectFacilitiesHeaderProps> = (args: SelectFacilitiesHeaderProps) => (

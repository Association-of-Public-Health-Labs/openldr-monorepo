...
import { LabDialog, type LabDialogProps } from "./LabDialog";

export default {
  title: "DesignSystem/Organisms/Popups/LabDialog",
  component: LabDialog,
  tags: ["autodocs"],
} as Meta;
...
const Template: StoryFn<LabDialogProps> = (args: LabDialogProps) => <LabDialog {...args} />;

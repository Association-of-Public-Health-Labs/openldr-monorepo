...
export function SignUpForm() {
  ...
  return (
    <div className="relative min-h-screen w-[300px] flex bg-yellow-500">
      ...
      {/* Right-side Form */}
      <div className="absolute right-0 bottom-0 top-0 z-10 flex min-h-screen h-[200px] w-[480px] items-center justify-center shadow-2xl bg-yellow-500">
            ...
            {step === "start" && (
              <>
                ...
                <p className="text-xs text-center text-gray-500 mt-2">
                  By creating an account you agree to Messimos{" "}
                  <a
                    href="/terms"

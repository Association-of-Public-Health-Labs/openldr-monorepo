...
const columns: ColumnDef<any>[] = [
  { accessorKey: "nome", header: "Nome do Paciente" },
  ...
  { accessorKey: "us", header: "US" },
  { accessorKey: "resultadoXpert", header: "Resultado de Xpert" },
  { accessorKey: "tipoAmostra", header: "Tipo de Amostra" },
  { accessorKey: "dataColheita", header: "Data de Colheita" },
  { accessorKey: "dataAnalise", header: "Data de Analise" },
];

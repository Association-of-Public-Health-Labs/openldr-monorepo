...
export default function MTBTestedSamplesDisaggregatedByDrug() {
    ...
    const chartData = useMemo(() =>
        prepareChartData(reportState.data, reportState.selectedDrug),
        [reportState.data, reportState.selectedDrug]
    );

    const availableDrugs = useMemo(() => getAvailableDrugs(), []);
    ...
    const handleDrugChange = useCallback((drugValue: string) => {
        setReportState(prev => ({ ...prev, selectedDrug: drugValue }));
    }, []);
    ...
    return (
        <>
            <MainCard
                ...
                footerComponent={
                    <Select value={reportState.selectedDrug} onValueChange={handleDrugChange}>
                        ...
                        <SelectContent>
                            <SelectGroup>
                                ...
                                {availableDrugs.map(drug => (
                                    <SelectItem key={drug.value} value={drug.value}>
                                        {drug.label}
                                    </SelectItem>
                                ))}
                            </SelectGroup>

...
export const API_CONFIG = {
  ENDPOINT: `${process.env.NEXT_PUBLIC_OPENLDR_API}/tb/gx/facilities/trl_samples_avg_by_days_by_month/`,
  TIMEOUT: 60000,
  RETRY_ATTEMPTS: 3,
  RETRY_DELAY: 1000,
} as const;
...
export const DEFAULTS = {
  ...
  REPORT_NAME: "Relatório de Tempo de Resposta por Mês",
} as const;

// Chart Configuration
export const CHART_CONFIG = {
  CHART_ID: "turnaround-time-by-month-chart",
  HEIGHT: 400,
  Y_LABEL: "Dias (média)",
  COLORS: [

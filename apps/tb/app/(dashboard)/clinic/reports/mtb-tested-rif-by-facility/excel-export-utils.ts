...
export function prepareChartDataForExcel(
  ...
  return reportState.data.map(item => ({
    [facilityTypeLabel]: item.Facility, // chave dinâmica
    "Amostras Testadas": item.Tested_Samples,
    "Resultados Positivos": item.Detected,
    "Resultados Negativos": item.Not_Detected,
    "Resultados Inválidos": item.Invalid,
    "Resistentes a Rifampicina": item.Rifampicin_Detected,
    "Sensíveis a Rifampicina": item.Rifampicin_Not_Detected,

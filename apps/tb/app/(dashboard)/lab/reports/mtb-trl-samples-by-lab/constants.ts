...
export const ENDPOINT = `${process.env.NEXT_PUBLIC_OPENLDR_API}/tb/gx/laboratories/registered_samples_by_month/`;
export const DEFAULT_TIME_INTERVAL = getLastTwelveMonths();
export const DEFAULT_LAB_TYPE: LabType = "Conventional";
export const REPORT_NAME = "Relatório de Amostras Registadas por mês";
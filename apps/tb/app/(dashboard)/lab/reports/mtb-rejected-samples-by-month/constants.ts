...
// export const REPORT_NAME = "Relatório de Amostras Rejeitadas por mês";
...
export const API_CONFIG = {
  BASE_URL: `${process.env.NEXT_PUBLIC_OPENLDR_API}/tb/gx/laboratories/rejected_samples_by_month/`,
...
export const DEFAULTS = {
  ...
  REPORT_NAME: "Relatório de Amostras Rejeitadas por mês",
} as const;

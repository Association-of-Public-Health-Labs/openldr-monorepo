...
export const buildApiParams = (
  ...
  console.log("baseParams-rejected-samples-by-lab-and-reason", { ...baseParams, ...facilityParams })
...
export const fetchFacilityData = async (
  ...
  try {
    ...
    console.log("response-rejected-samples-by-lab-and-reason", response.data, params)
